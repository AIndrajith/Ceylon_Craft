...
const Footer = () => {
  return (
    <div className='w-full h-auto bg-rose-900 text-white font-winkySans p-4 md:p-6'>
      <div className='grid grid-cols-1 lg:grid-cols-4 gap-8 md:gap-12'>
        ...
        <div className='flex flex-col items-center sm:items-start justify-center p-2'>
          ...
          <span className='text-center sm:text-left mt-3 text-lg md:text-xl'>
        ...
        {/* Occasions */}
        <div className='p-2'>
          <span className='font-semibold text-2xl md:text-3xl'>For Occasions</span>
        ...
        <div className='p-2'>
          ...
          <div className='mt-2 space-y-2 text-lg md:text-xl'>
            ...
            <div className='flex gap-3 items-center'>
              <img className='w-6 h-6 flex-shrink-0' src={assets.whatsapp} alt="WhatsApp" />
              <p>071-1234567</p>
            </div>
          </div>
        </div>
        ...
        {/* Social Media */}
        <div className='p-2'>
          <span className='font-semibold text-2xl md:text-3xl'>Follow Us</span>
          <div className='py-2 flex items-center gap-4 mt-2'>
            <a href="#" aria-label="Facebook">
              <img className='w-8 h-8' src={assets.facebook} alt="Facebook" />
            </a>
            <a href="#" aria-label="Instagram">
              <img className='w-8 h-8' src={assets.instagram} alt="Instagram" />
            </a>
            <a href="#" aria-label="TikTok">
              <img className='w-8 h-8' src={assets.tiktok} alt="TikTok" />
            </a>
          </div>
        </div>
      </div>
      ...
      <div className='mt-8 pt-4 border-t border-rose-800 text-center text-lg md:text-xl'>
